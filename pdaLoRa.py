# https://github.com/lobeck/raspi-rf95-lora-receiver.py
# Code changed by Henrique Bruno
# This code is projected to be initialized by pdaMain, called by multiprocessing, calling the init() function.

import wiringpi         # "sudo pip install wiring pi"
import time
    ...
    if managerDict["readingRF"] and not managerDict["shutdownRequested"]:
        ...
        if result.rx_done():
            ...
            if data[4:8] == RF_CUSTOM_HEADER_LIST:
                global global_last_second_callback_time
                global global_byte_sum
                global global_bytesPerSecond
                timePassedBPS = time.time() - global_last_second_callback_time
                if timePassedBPS > BYTE_PER_SECOND_DELAY:
