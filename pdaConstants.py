...
DATA_LIST_MAX_PACKETS = 1000000                             # Array positions

DATA_LOG_ARRAY_LENGTH = DATA_LIST_MAX_PACKETS * DATA_LIST_VARIABLES  # Total array size

# EXTRA LOG
EXTRA_LOG_MAX_STRING_LENGTH = 128
EXTRA_LOG_MAX_PACKETS = 1000
EXTRA_LOG_ARRAY_LENGTH = EXTRA_LOG_MAX_STRING_LENGTH * EXTRA_LOG_MAX_PACKETS
